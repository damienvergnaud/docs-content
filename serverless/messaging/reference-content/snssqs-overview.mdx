...
You can create an SQS/SNS namespace in a few clicks from the [Scaleway console](https://console.scaleway.com) by [following our how-to](/serverless/messaging/how-to/create-namespace). Alternatively, you can also create your SQS/SNS namespace using the [Scaleway API](https://developers.scaleway.com/en/).
...
You can [create queues](/serverless/messaging/how-to/create-manage-queues/) in a namespace via the Scaleway console. You can choose to create either a Standard or FIFO queue, and tweak parameters such as visibility timeout, message retention period, maximum message size and content based deduplication.
