...
You can create an SNS/SQS namespace in a few clicks from the [Scaleway console](https://console.scaleway.com) by [following our how-to](/serverless/messaging/how-to/create-namespace). Alternatively, you can also create your SNS/SQS namespace using the [Scaleway API](https://developers.scaleway.com/en/).
